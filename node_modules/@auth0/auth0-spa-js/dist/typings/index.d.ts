...
import '@auth0/auth0-spa-js/dist/typings/global';
export * from '@auth0/auth0-spa-js/dist/typings/global';
/**
...
export { Auth0Client };
export { GenericError, AuthenticationError, TimeoutError, PopupTimeoutError, PopupCancelledError, MfaRequiredError, MissingRefreshTokenError } from '@auth0/auth0-spa-js/dist/typings/errors';
export { ICache, LocalStorageCache, InMemoryCache, Cacheable, DecodedToken, CacheEntry, WrappedCacheEntry, KeyManifestEntry, MaybePromise, CacheKey, CacheKeyData } from '@auth0/auth0-spa-js/dist/typings/cache';
